    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <nav className="border-b border-slate-800 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg">Postgres Guardrails</span>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-900/40 border border-blue-700/50 rounded-full text-blue-400 text-sm font-medium mb-8">
            <Zap size={12} /> Safe, Provable PostgreSQL Performance
          </div>
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Detect risky query regressions, validate recommendations safely, and enforce approval guardrails before production rollout.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: Shield, title: 'Guardrails + Approvals', desc: 'Policy checks, risk scoring, and approval queues prevent unsafe performance changes.', color: 'text-emerald-400', bg: 'bg-emerald-900/20' },
            ].map(f => (
      ...
      <section className="py-20 px-6 border-t border-slate-800 bg-slate-900/30">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: '01', title: 'Detect', desc: 'Continuously identify expensive and regressing PostgreSQL queries from live workload telemetry.' },
              { step: '02', title: 'Validate', desc: 'Run policy and risk checks, then validate recommendations with measurable before/after evidence.' },
              { step: '03', title: 'Approve', desc: 'Use approval workflows and immutable audit trails before rollout decisions.' },
            ].map((s, i) => (
      ...
      <footer className="border-t border-slate-800 py-8 px-6 text-center text-sm text-slate-600">
        <div className="flex items-center justify-center gap-6">
          <span>© 2026 Postgres Guardrails</span>
